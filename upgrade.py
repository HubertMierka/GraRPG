...
class Upgrade:
    ...
    def display(self):
        ...
        for index, item in enumerate(self.item_list):
            ...
            item.dispaly(self.dispay_surface,self.selection_index,name,value,max_value,cost)
...
class Item:
    ...
    def display_bar(self,surface,value,max_value,selected):
        ...
        color = UI_BORDER_COLOR if selected else TEXT_COLOR
    ...
    def dispaly(self,surface,selection_num,name,value,max_value,cost):
